      ...
      <div class="menu_content">
        <ul class="menu_items">
          ...
          <li class="item">
            ...
            <ul class="menu_items submenu">
              <a href="approve_consultations.php" class="nav_link sublink">Approve consultations</a>
        ...
        <ul class="menu_items">
          <div class="menu_title meynu_editor"></div>
          <!-- duplicate these li tag if you want to add or remove navlink only -->
          <!-- Start -->
          <li class="item">
            <a href="make_appointments.php" class="nav_link">
              <span class="navlink_icon">
                <i class="bx bxs-magic-wand"></i>
              </span>
              <span class="navlink">Your Appointments</span>
            </a>
          </li>
          <!-- End -->

          <li class="item">
            <a href="upcoming_events.php" class="nav_link">
              <span class="navlink_icon">
                <i class="bx bx-loader-circle"></i>
              </span>
              <span class="navlink">Upcoming Events</span>
            </a>
          </li>
          <li class="item">
        ...
        <ul class="menu_items">
          <div class="menu_title meynu_setting"></div>
          <li class="item">
