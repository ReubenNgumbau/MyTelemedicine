  ...
  <body>
    ...
    <nav class="sidebar">
      <div class="menu_content">
        <ul class="menu_items">
          ...
          <li class="item">
            ...
            <ul class="menu_items submenu">
              ...
              <a href="cancel_consultation.php" class="nav_link sublink">Cancel appointment</a>
            </ul>
          </li>
          <!-- end -->
        </ul>
        ...
        <ul class="menu_items">
          <div class="menu_title menyu_editor"></div>
        ...
        <ul class="menu_items">
          <div class="menu_title menyu_setting"></div>
          <li class="item">
          ...
          <li class="item">
            <a href="text.php" class="nav_link">
              <span class="navlink_icon">
                <i class="bx bx-cog"></i>
              </span>
